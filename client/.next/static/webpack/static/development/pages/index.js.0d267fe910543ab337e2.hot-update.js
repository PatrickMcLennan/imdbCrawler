...
})(["display:inline-flex;margin:1.5vh;padding:1.5vh;border:1px solid black;transition:all 0.3s ease-in-out;overflow:hidden;& img{height:150px;width:auto;margin-right:1.5vh;}& figcaption{display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;}& h3{font-size:2rem;text-transform:uppercase;letter-spacing:0.15rem;}& a{border:1px solid black;padding:1rem 2rem;transform:translateY(300%);transition:all 0.3s ease-in-out;& span{font-style:italic;}}&:hover{transform:scale(1.1);& a{transform:translateY(0);}}"]);
...
//# sourceMappingURL=index.js.0d267fe910543ab337e2.hot-update.js.map