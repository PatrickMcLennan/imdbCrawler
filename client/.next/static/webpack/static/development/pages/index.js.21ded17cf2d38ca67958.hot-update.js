...
})(["display:inline-flex;margin:1.5vh 0.75vh;padding:1.5vh;border:1px solid black;transition:all 0.3s ease-in-out;overflow:hidden;background:#e3e3e3;& img{height:125px;width:auto;margin-right:1.5vh;}& figcaption{flex-direction:column;justify-content:space-evenly;align-items:center;}& h3{font-size:2rem;font-weight:100;text-transform:uppercase;letter-spacing:0.15rem;}& h4{font-size:1.75rem;}& a{border:1px solid black;padding:1rem 2rem;transform:translateY(300%);transition:all 0.3s ease-out;& span{font-style:italic;}}&:hover{transform:scale(1.1);& a{transform:translateY(0);}}"]);
...
//# sourceMappingURL=index.js.21ded17cf2d38ca67958.hot-update.js.map