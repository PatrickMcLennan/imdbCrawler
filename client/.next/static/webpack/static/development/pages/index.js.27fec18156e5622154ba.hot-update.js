...
})(["display:inline-flex;margin:1.5vh;padding:1.5vh;border:1px solid black;transition:all 0.3s ease-in-out;overflow:hidden;& img{height:175px;width:auto;margin-right:1.5vh;}& figcaption{display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;}& h3{font-size:2rem;text-transform:uppercase;letter-spacing:0.15rem;}& h4{font-size:1.75rem;font-weight:100;}& a{border:1px solid black;padding:1rem 2rem;transform:translateY(300%);transition:all 0.3s ease-in-out;& span{font-style:italic;}}&:hover{transform:scale(1.1);& a{transform:translateY(0);}}"]);
...
//# sourceMappingURL=index.js.27fec18156e5622154ba.hot-update.js.map