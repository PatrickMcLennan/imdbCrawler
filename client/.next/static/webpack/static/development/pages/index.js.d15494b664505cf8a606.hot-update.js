...
})(["display:inline-flex;margin:1.5vh;padding:1.5vh;border:1px solid black;cursor:pointer;transition:all 0.3s ease-in-out;overflow:hidden;& img{height:150px;width:auto;margin-right:1.5vh;}& figcaption{display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;}& a{border:1px solid black;padding:1rem 2rem;& span{font-style:italic;}}&:hover{transform:scale(1.1);}"]);
...
//# sourceMappingURL=index.js.d15494b664505cf8a606.hot-update.js.map